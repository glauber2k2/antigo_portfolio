    ...
    <div className={styles.container}>
      ...
      <main className='flex flex-col p-4 sm:p-36 h-4/5 justify-center items-center sm:items-start mt-6'>
        ...
        >
          <button
            onClick={abrirWpp}
            className='flex justify-center items-center w-52 h-10 sm:h-12 sm:w-72 gap-4 rounded-lg bg-white hover:bg-purple-500 text-black text-lg font-medium sm:mt-0 mt-8 relative group'
          >
          ...
          <div className='flex gap-8 items-center justify-center sm:gap-4 mt-4 sm:mt-0'>
            <button
              onClick={abrirInsta}
              className='bg-white hover:bg-purple-500 rounded-full text-black w-10 h-10 sm:h-12 sm:w-12 flex justify-center items-center relative group'
            >
              <InstagramLogo
                weight='fill'
