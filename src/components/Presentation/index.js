...
export default function Presentation() {
  return (
    ...
    >
      <div
        className='relative bg-black sm:gap-4 p-1 text-black flex justify-center gap-2 before:content-["Habilidades"] before:text-white before:text-xl before:absolute before:top-[-32px] before:w-full before:text-center  before:bg-black before:px-1 flex-wrap'
        data-aos='fade-up'
        data-aos-delay='100'
      >
        <div data-aos='fade-up' data-aos-delay='100'>
          <span className='flex w-16 sm:w-[10vw] h-32 sm:h-[16vw] flex-col justify-center items-center gap-2 ease-out duration-300 bg-purple-500 select-none hover:scale-110'>
            <svg
              x='0px'
              y='0px'
              width='100'
            ...
            <p className='text-[8px] md:text-xs lg:text-base xl:text-lg font-semibold'>
              Nextjs
            </p>
          </span>
        </div>
        ...
        <div data-aos='fade-up' data-aos-delay='100'>
          <span className='flex w-16 sm:w-[10vw] h-32 sm:h-[16vw] flex-col justify-center items-center gap-2 ease-out duration-300 bg-purple-500 select-none hover:scale-110'>
            <Atom className='sm:w-12 sm:h-12 w-8 h-8' weight='fill' />
            <p className='text-[8px] md:text-xs lg:text-base xl:text-lg font-semibold'>
              React
            </p>
          </span>
        ...
        <div data-aos='fade-up' data-aos-delay='100'>
          <span className='flex w-16 sm:w-[10vw] h-32 sm:h-[16vw] flex-col justify-center items-center gap-2 ease-out duration-300 bg-purple-500 select-none hover:scale-110'>
            <FileJs className='sm:w-12 sm:h-12 w-8 h-8' weight='fill' />
            <p className='text-[8px] md:text-xs lg:text-base xl:text-lg font-semibold'>
              Javascript
            </p>
          </span>
        ...
        <div data-aos='fade-up' data-aos-delay='100'>
          <span className='flex w-16 sm:w-[10vw] h-32 sm:h-[16vw] flex-col justify-center items-center gap-2 ease-out duration-300 bg-purple-500 select-none hover:scale-110'>
            <FileTs className='sm:w-12 sm:h-12 w-8 h-8' weight='fill' />
            <p className='text-[8px] md:text-xs lg:text-base xl:text-lg font-semibold'>
              Typescript
            </p>
          </span>
        ...
        <div data-aos='fade-up' data-aos-delay='100'>
          <span className='flex w-16 sm:w-[10vw] h-32 sm:h-[16vw] flex-col justify-center items-center gap-2 ease-out duration-300 bg-purple-500 select-none hover:scale-110'>
            <AngularLogo className='sm:w-12 sm:h-12 w-8 h-8' weight='fill' />
            <p className='text-[8px] md:text-xs lg:text-base xl:text-lg font-semibold'>
              Angular
            </p>
          </span>
        ...
        <div data-aos='fade-up' data-aos-delay='100'>
          <span className='flex w-16 sm:w-[10vw] h-32 sm:h-[16vw] flex-col justify-center items-center gap-2 ease-out duration-300 bg-purple-500 select-none hover:scale-110'>
            <FigmaLogo className='sm:w-12 sm:h-12 w-8 h-8' weight='fill' />
            <p className='text-[8px] md:text-xs lg:text-base xl:text-lg font-semibold'>
              Figma
            </p>
          </span>
